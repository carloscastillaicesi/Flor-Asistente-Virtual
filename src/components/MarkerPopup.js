...
import Detailed from "../components/Profile-Components/Detailed";
...
export default function MarkerPopup({ setOpen, name, pic }) {
 ...
 return (
  <Popup autoPan={false} closeButton={false} onClose={handleClose.bind(this)} onOpen={handleOpen.bind(this)}>
   ...
   <Route exact path={["/map/aboutme/plants", "/map/aboutme/userinfo", "/map/aboutme/exchange", "/map/aboutme/documents", "/map/aboutme/gallery", "/map/aboutme/detail"]}>
    <TopProfileBar setOpen={setOpen} />
   </Route>
